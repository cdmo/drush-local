...
$options['shell-aliases']['pull-prod-data'] = '!drush sql-sync -v {{#prod}} {{@target}} --no-cache  && drush golocal';
$options['shell-aliases']['pull-prod-all'] = '!drush sql-sync -v {{#prod}} {{@target}} --no-cache && drush rsync -v {{#prod}}:%files {{@target}}:%files && drush golocal';
